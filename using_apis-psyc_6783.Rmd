...
Play around with the search browser, look at the web link after filtering, will get something like https://www.consumerfinance.gov/data-research/consumer-complaints/search/?company=EQUIFAX%2C%20INC.&dataNormalization=None&dateRange=3y&date_received_max=2022-02-10&date_received_min=2019-02-10&has_narrative=true&searchField=all&searchText=Equifax&tab=Map.
...
request
```
If paste the web link above to web, can get a json file including the information you requested.
